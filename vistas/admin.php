...
<head>
    ...
    <script type="module" src="../js/verJugadores.js"></script>
</head>
...
<body>
    ...
    <main class="main align-items-center justify-content-center justify-content-md-between container-fluid">
        <div class="articulo text-white container-fluid" style="max-width: 82.9375rem; margin:auto;margin-top: 13vh; padding-top:3rem;padding-left:3rem;min-width:38rem;">
            <div class="row">
        ...
        <div class="articulo text-white table-responsive" style="max-width: 82.9375rem; margin:auto;margin-top: 10vh;padding:0;padding-top:2rem;padding-bottom:2rem;min-width:38rem;">
            <table style="margin:auto;">
                ...
                <tbody id="tabla">
                    <?php foreach ($jugadores as $value) : ?>
                        <tr style="height: 64px;" id="<?= $value["id"]; ?>">
                            <td  style="display: contents;"><?= $value["imagen"]; ?></td>
                            <td><?= $value["nombre"]; ?></td>
                            <td><?= $value["pos"];?>
                        <?php if($value["2ndPos"]){echo(" - " . $value["2ndPos"]);} ?></td>
                            <td><?= $value["ftm"]; ?></td>
                            <td><?= $value["2pm"]; ?></td>
                            <td><?= $value["3pm"]; ?></td>
                            <td><?= $value["reb"]; ?></td>
                            ...
                            <td class="px-1">
                                <button style="width: 4rem;" name="eliminar" class=" boton text-center">
                                ...
                                <button style="width: 4rem;" name="editar" class=" boton text-center verde">
