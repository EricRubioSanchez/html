                    ...
                    <div class="articulo text-white container-fluid" style="margin:auto;">
                        ...
                        <div class="jugadores">
                            <div class="row">
                                ...
                                <div class="col col-9">
                                    <div class="row">
                                        <div class="col col-6 nombre" style="margin: auto;">Jarret Allen</div>
                                        ...
                                        <div class="col col-4 text-end">
                                            <div class="btn-group dropbox">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-dark">
                                                    ...
                                                    <li><a class="dropdown-item" href="#">Pagar Cláusula</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col col-9">
                                    <div class="row">
                                        <div class="col col-6" style="margin: auto;">Jarret Allen</div>
