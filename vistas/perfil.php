                        ...
                        <div class="row">
                            <div class="col col-6">
                                <div class="form-group mb-5 mt-5">
                                    ...
                                    <div class="row">
                                        <div class="col col-9">
                                            <input required type="text" class="form-control" id="nombre" value="Eric Rubio Sanchez">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group mb-3 mt-5">
                                    ...
                                    <div class="row">
                                        <div class="col col-9"><input required type="password" class="form-control" id="contra" value="P@ssw0rd"></div>
                                        <div class="col col-3">
                                            <button class="boton" id="botonContra" onclick="canviarContra()" style="min-height:0px;" type="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
