...
<head>
    ...
    <script>
        ...
        function canviarContra2() {
            var x = document.getElementById("contra2");
            let boton = document.getElementById("botonContra2");
            if (x.type === "password") {
                x.type = "text";
                boton.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="16" alt="ojoTachado" height="16" fill="currentColor" class="bi bi-eye-slash-fill" viewBox="0 0 16 16"><path d="m10.79 12.912-1.614-1.615a3.5 3.5 0 0 1-4.474-4.474l-2.06-2.06C.938 6.278 0 8 0 8s3 5.5 8 5.5a7 7 0 0 0 2.79-.588M5.21 3.088A7 7 0 0 1 8 2.5c5 0 8 5.5 8 5.5s-.939 1.721-2.641 3.238l-2.062-2.062a3.5 3.5 0 0 0-4.474-4.474z"/><path d="M5.525 7.646a2.5 2.5 0 0 0 2.829 2.829zm4.95.708-2.829-2.83a2.5 2.5 0 0 1 2.829 2.829zm3.171 6-12-12 .708-.708 12 12z"/></svg>';
            } else {
...
<body>
    ...
    <main class="main d-flex flex-wrap align-items-center justify-content-center justify-content-md-between container" style="padding-left: 0px;">
        <div class="articulo text-white container" style="width: 42.9375rem; margin:auto;margin-top: 17vh;">
            ...
            <form class="needs-validation px-4 " novalidate method="POST" action="../controlador/signin.php">
                <h1>Registrarse</h1>
                <div class="form-group mb-3 mt-4">
                    <label for="nombre">Nombre Completo</label>
                    <input required type="text" <?php if(isset($nom)){ echo("value='".$nom."'");} ?> class="form-control" style="width:38rem;" name="nombre" id="nombre" placeholder="Name">
                ...
                <div class="form-group mb-3">
                    ...
                    <input required type="email" <?php if(isset($correu)){ echo("value='".$correu."'");} ?> class="form-control" name="correo" id="correo" style="width:38rem;" placeholder="example@gmail.com">
                    <div class="invalid-feedback">
                ...
                <div class="input-group mb-3">
                    ...
                    <br>
                    <input required type="password" minlength="6" style="display:inline-block;width:35rem;" name="contra1" class="form-control" id="contra" placeholder="P@ssw0rd">
                ...
                <div class="input-group mb-3">
                    <label for="contra2">Vuelve a introducir contraseña</label>
                    <br>
                    <input required type="password" minlength="6" name="contra2" style="display:inline-block;width:35rem;" class="form-control" id="contra2" placeholder="P@ssw0rd">
                    <div class="input-group-append">
                        <button onclick="canviarContra2()" id="botonContra2" class="btn btn-danger pb-1" style="min-height:0px;" type="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
                                <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0" />
                                <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8m8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7" />
                            </svg></button>
                    </div>
