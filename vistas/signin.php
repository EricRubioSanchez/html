...
<body>
    ...
    <main class="main d-flex flex-wrap align-items-center justify-content-center justify-content-md-between container">
        <div class="articulo text-white container" style="width: 62.9375rem; margin:auto;margin-top: 13vh;">

            <form class="needs-validation px-4 " novalidate>
                <h1>Registrarse</h1>
                <div class="form-group mb-3 mt-4">
                    <label for="nombre">Nombre Completo</label>
                    <input required type="text" class="form-control" style="width:80%;" id="nombre" placeholder="Name">
                ...
                <div class="form-group mb-3">
                    ...
                    <input required type="email" class="form-control" id="correo"  style="width:80%;" placeholder="example@gmail.com">
                    <div class="invalid-feedback">
                ...
                <div class="form-group mb-3">
                    ...
                    <button onclick="canviarContra()" id="botonContra" class="boton pb-1" style="min-height:0px;" type="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
